  ...
  services = [
    {
      ...
      desc: 'Felújítások és építkezések során keletkezett sitt, valamint feleslegessé vált bútorok, lomok és hagyatékok gyors, szakszerű elszállítása kézi rakodással.',
